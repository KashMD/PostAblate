  ...
  return (
    <div className="mx-auto max-w-5xl px-4 py-10 sm:px-6 lg:px-8">
      ...
      <div className="grid gap-4">
        ...
        <section className="rounded-lg border border-slate-200/80 bg-white/95 p-6 shadow-card">
          <h2 className="text-xl font-semibold tracking-tight text-navy">What this MVP supports</h2>
        ...
        <section className="rounded-lg border border-slate-200/80 bg-white/95 p-6 shadow-card">
          <h2 className="text-xl font-semibold tracking-tight text-navy">What this MVP does not do</h2>
        ...
        <section className="rounded-lg border border-slate-200/80 bg-white/95 p-6 shadow-card">
          <h2 className="text-xl font-semibold tracking-tight text-navy">Conservative triage philosophy</h2>

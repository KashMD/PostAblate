...
export const mockSubmissions: MockSubmission[] = [
  ...
  { initials: "LK", ablationDate: "2026-05-01", accessSite: "Neck", type: "One-month follow-up", category: "routine", concern: "Medication question without missed doses", submittedDate: "2026-05-31", status: "Reviewed" },
